  ...
  describe("should throw an error", function () {
    it("when no arguments is specified", function () {
      expect(function () {
        ...
        TypeError,
        "You must specified an variable and type to evaluate"
      );
    });
    ...
    it("when type is not specified", function () {
      expect(function () {
        ...
        TypeError,
        "You must send the 'type' of variable is evaluated."
      );
    });
    ...
    it("when a specified type is not supported", function () {
      expect(function () {
        ...
        TypeError,
        "Specified type test is invalid. See the supported types"
      );
    });
    ...
    it("when a variable have a type different instead the specified", function () {
      expect(function () {
        evaluate("", "number");
      }).to.throw(TypeError, "Your variable is already set and isn't a Number");
    });
  });
